...
smf_opt_target, _, b_mu, sig_inv_half, _ = mi_target(np.asarray(bag_list), labels, parameters)
...
ace_opt_target, _, b_mu, sig_inv_half, _ = mi_target(np.asarray(bag_list), labels, parameters)
